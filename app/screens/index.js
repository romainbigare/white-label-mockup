...
export const SCREENS = Object.fromEntries([
  ...
  S('A13C', 'Confirm subscription', 'New at review 21/09 (second pass): the App Store purchase sheet, drawn as the drawer a farmer actually meets when he presses Start free trial. The 21/09 call settled that Wafra never sees a card — “we don’t charge a credit card, as the subscription is through Apple/Google” — and A13 says that in words; this is the same fact in the form it arrives. Deliberately not our design system: it is Apple’s sheet, drawn to iOS’s own metrics, because the point is that it is not ours to change. The Android equivalent is Google Play’s and is named on A13.', [], onboarding.A13C),
...
export const SCREEN_GROUPS = [
  ...
  // sitting.
  { name: 'First run', ids: ['A1', 'A1B', 'A4', 'A4A', 'A4B', 'A4C', 'A4D', 'A5', 'A6', 'A9', 'A9E', 'A9F', 'A10', 'A10C', 'A10B', 'A11', 'A13', 'A13B', 'A13C', 'A14'] },
...
export const FLOWS = [
     ...
     reached from Farm settings instead of from sign-up. */
  {
    ...
    ids: ['A1', 'A1B', 'A4', 'A5', 'A6', 'A9', 'A9E', 'A10', 'A10C', 'A10B', 'A11', 'A13', 'A13C'],
  },
  {
    section: 'First run',

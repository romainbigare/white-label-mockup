...
export const SCREENS = Object.fromEntries([
  ...
  S('D2', 'Irrigation advice', 'How much water, said as volume and as hours at the pump. The assumptions behind the figure are on the screen and can be corrected.', ['WF5.111', 'WF5.112', 'WF5.113', 'WF5.114', 'WF5.115', 'WF5.116', 'WF5.117', 'WF5.118'], advice.D2),
  ...
  /* -- Tasks -------------------------------------------------------------- */
  S('E1', 'Tasks / My Work', 'The day’s work. Anything overdue sits at the top and looks different, so it is hard to scroll past. A worker sees only their own.', ['WF5.133', 'WF5.134', 'WF5.135', 'WF5.136', 'WF5.137', 'WF5.139', 'WF5.140', 'WF5.141'], tasks.E1),

...
export const SCREENS = Object.fromEntries([
  ...
  S('B9', 'Tree list', 'Leads with the distribution. Missing and dead trees keep their own count.', ['WF-238', 'WF-239', 'WF-240', 'WF-242', 'WF-243'], trees.B9),
  S('B10', 'Tree detail', 'ID, QR, species, age, position, health, 12-month trend and history.', ['WF-241', 'WF-244'], trees.B10),

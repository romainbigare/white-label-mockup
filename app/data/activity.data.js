...
export default {
 "advice": [
  ...
  },
  {
   ...
   "ruleVersion": "irr-2026.7.3",
   "action": "Apply 53 m³/ha today",
   "amount": "53 m³/ha this morning, from 8 a.m.",
   "reason": "Soil moisture at 62% of available capacity; citrus ET is high at this temperature",
   "status": "open",
   "supersededBy": null,
   "detail": {
    "headline": "53 m³/ha today",
    ...
    "products": [
     {
      "name": "Urea (46% N)",
      "rate": "70 g per tree",
      "total": "80 kg in 1,120 L of spray"
     },
     {
      "name": "Zinc sulphate (36% Zn)",
      "rate": "7 g per tree",
      "total": "8 kg in 1,120 L of spray"
     }
    ],
    "preHarvestIntervalDays": null,
    "earliestSafeHarvest": null,
 ...
 "team": [
  {
   ...
   "company": "Al Kharj Agricultural Co.",
   "role": "owner",

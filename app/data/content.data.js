...
export default {
 ...
 "helpArticles": [
  {
   ...
   "body": [
    "To start using Wafra, you need to add at least one farm. A farm is your top-level unit — its boundary holds the plots and the trees inside it. You can add a farm either by searching for it on the map or by drawing its boundary yourself. If you import cadastral data, Wafra can help you match it to the map.",
    ...
    "Once your farm is added, you can draw its plots or send the boundary for a survey, invite your team, and begin receiving advice."
   ],
   "steps": [
    ...
    "You can now add plots and crops."
   ],
   "readMins": 3
  },
  {
  ...
  },
  {
   ...
   "body": [
    ...
    "You can filter by farm, plot, type or status. Archive advice once you have acted or decided not to act. Your team members will also receive relevant advice if they have permission."
   ],
   "steps": null,
   "readMins": 2
  },
  {
   ...
   "body": [
    ...
    "Each entry includes the date, plot, crop, product or action, quantity, and notes. You can also attach photos. Wafra uses this data to forecast disease risk, optimise nutrients, and generate reports.",
  ...
  },
  {
   ...
   "body": [
    ...
    "Wafra's support team is available in your language and can help with technical issues, questions about your plan, or advice on features. Response times are guaranteed on Pro.",
 ...
 "cacheTable": [
  {
   "what": "Farm, plot and tree records",
   "cached": true,

...
| the deck | the note box lost its heading. It said *THE REVIEWER'S ASSUMPTION*, which is a box announcing whose thought it is before saying the thought. Six pages carry one now, and what they carry has widened with the label gone: C3 and C5 say what those two screens are, and D1 carries the whole taxonomy of its three menus |
